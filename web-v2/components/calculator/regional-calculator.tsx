...
export function RegionalCalculator(){
 ...
 function end(c:AbortController){setBusy(false);abort.current=null;setProgress(p=>({...p,message:c.signal.aborted?'Stopped. Only completed requests are retained.':'Completed. Review coverage and download results.'}));}
